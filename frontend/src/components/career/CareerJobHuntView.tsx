...
const STAGES: { key: JobStage; label: string; color: string; border: string }[] = [
 { key: 'targeted', label: 'Targeted', color: 'text-slate-300 bg-slate-800/80', border: '' },
...
export const CareerJobHuntView: React.FC = () => {
 ...
 <div className="glass-panel rounded-2xl p-5 shadow-glass flex flex-col md:flex-row items-start md:items-center justify-between gap-4 relative overflow-hidden">
 ...
 <div className="flex items-center p-1 rounded-xl bg-slate-950/80 font-mono text-xs shadow-inner">
 <button
 ...
 <div
 key={stage.key}
 className="glass-panel rounded-2xl p-4 shadow-glass flex flex-col gap-3 min-h-[520px] bg-slate-900/40"
 >
 {/* Stage Header */}
 ...
 <span className="text-xs font-mono text-slate-400 font-bold bg-slate-950 px-2 py-0.5 rounded-md ">
 {stageApps.length}
 </span>
 </div>
 ...
 className="p-3.5 rounded-xl bg-slate-950/80 hover:border-slate-700 transition-all shadow-md group relative flex flex-col gap-2"
 >
 ...
 <span className="inline-flex items-center gap-0.5 text-slate-400 bg-slate-900 px-1.5 py-0.5 rounded ">
 ...
 <span
 key={t}
 className="text-[10px] font-mono px-1.5 py-0.5 rounded bg-slate-900 text-cyan-300"
 >
 {t}
 </span>
 ))}
 ...
 {app.notes && (
 <p className="text-[11px] text-slate-400 bg-slate-900/60 p-2 rounded-lg line-clamp-2">
 {app.notes}
 </p>
 )}
 ...
 className="text-[10px] font-mono bg-slate-900 text-slate-300 rounded px-1.5 py-1 focus:outline-none focus:border-emerald-500 cursor-pointer"
 >
 ...
 <div
 key={tpl.id}
 className="glass-panel rounded-2xl p-5 shadow-glass flex flex-col justify-between gap-4 bg-slate-900/50 relative overflow-hidden group hover:border-slate-700"
 >
 <div>
 ...
 <span
 key={t}
 className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-slate-800 text-slate-300"
 >
 {t}
 </span>
 ))}
 ...
 <p className="text-xs font-mono text-cyan-300 font-semibold bg-slate-950 p-2 rounded-lg ">
 {tpl.subject}
 </p>
 </div>
 ...
 <pre className="text-xs font-mono text-slate-200 bg-slate-950/90 p-3 rounded-xl whitespace-pre-wrap leading-relaxed max-h-48 overflow-y-auto">
 {tpl.body}
 </pre>
 </div>
 </div>
 ...
 <div
 key={proj.id}
 className="glass-panel rounded-2xl p-6 shadow-glass flex flex-col justify-between gap-4 bg-slate-900/60 relative overflow-hidden"
 >
 <div>
 ...
 target="_blank"
 rel="noreferrer"
 className="p-2 rounded-xl bg-slate-900 text-slate-300 hover:text-white hover:border-slate-700 transition-all"
 >
 ...
 <span
 key={tech}
 className="text-[11px] font-mono px-2 py-0.5 rounded-md bg-slate-900 text-violet-300"
 >
 {tech}
 </span>
 ))}
 ...
 className="px-4 py-2 rounded-xl bg-slate-900 hover:border-slate-600 text-slate-200 text-xs font-mono font-bold flex items-center gap-2 transition-all cursor-pointer"
 >
 {copiedId === proj.id ? (
 <>
