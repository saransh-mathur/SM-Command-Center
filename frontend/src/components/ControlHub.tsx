...
export const ControlHub: React.FC = () => {
  ...
  return (
    <section className="w-full">
      <div className="bg-slate-900/80 backdrop-blur-md border border-slate-800/80 rounded-2xl p-4 sm:p-5 shadow-glass transition-all hover:border-slate-700/80">
        
        {/* Header Title & Tag */}
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 pb-4 mb-4 border-b border-slate-800/60">
          ...
          <div className="flex items-center gap-2 self-end sm:self-auto">
            <span className="text-[11px] font-mono text-slate-400 px-2.5 py-1 rounded-lg bg-slate-950/60 border border-slate-800">
              SOCKET: <span className="text-emerald-400">CONNECTED</span>
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className={`p-4 rounded-xl border transition-all duration-300 ${
            isAgyActive 
              ? 'bg-slate-900/90 border-emerald-500/30 shadow-glow-emerald' 
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <h3 className="text-sm font-bold text-slate-100">AGY Streamlit Dashboard</h3>
                    {/* Live Status Badge */}
                    {isAgyLoading ? (
                      <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md text-[11px] font-mono font-medium bg-amber-500/15 border border-amber-500/30 text-amber-400">
                        <Loader2 className="w-3 h-3 animate-spin" />
                        UPDATING...
                      </span>
                    ) : isAgyActive ? (
                      <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md text-[11px] font-mono font-medium bg-emerald-500/15 border border-emerald-500/40 text-emerald-400 shadow-sm">
                        <CheckCircle2 className="w-3 h-3" />
                        ACTIVE (Port 8501)
                      </span>
                    ) : (
                      <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md text-[11px] font-mono font-medium bg-rose-500/15 border border-rose-500/30 text-rose-400">
            ...
            <div className="mt-4 pt-3 border-t border-slate-800/60 flex items-center justify-between gap-3">
              ...
              <a
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-mono flex items-center gap-1.5 border transition-all ${
                  isAgyActive
                    ? 'bg-slate-800/80 hover:bg-slate-700 border-slate-700 text-cyan-300 hover:border-cyan-500/50'
                    : 'bg-slate-900/40 border-slate-800/50 text-slate-600 cursor-not-allowed pointer-events-none'
                }`}
              >
                <span>Open App</span>
          ...
          {/* ========================================================= */}
          <div className="p-4 rounded-xl bg-slate-900/90 border border-slate-800/80 transition-all duration-300 hover:border-cyan-500/30">
            <div className="flex items-start justify-between gap-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="px-2 py-0.5 rounded-md text-[11px] font-mono bg-cyan-500/10 border border-cyan-500/30 text-cyan-400">
                      LIVE PULSE
                    </span>
                  </div>
            ...
            {/* Actions Bar */}
            <div className="mt-4 pt-3 border-t border-slate-800/60 flex flex-wrap items-center justify-between gap-2.5">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-lg text-xs font-mono bg-slate-800/80 hover:bg-slate-700 border border-slate-700 text-slate-200 hover:border-cyan-500/50 flex items-center gap-1.5 transition-all"
              >
