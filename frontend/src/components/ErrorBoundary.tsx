...
export class ErrorBoundary extends Component<Props, State> {
 ...
 <div className="max-w-md w-full glass-panel rounded-2xl border-rose-500/40 p-6 shadow-2xl bg-slate-900/90 text-center">
 <div className="w-12 h-12 rounded-2xl bg-rose-500/20 border-rose-500/40 text-rose-400 flex items-center justify-center mx-auto mb-4">
 ...
 {this.state.error && (
 <div className="p-3 rounded-xl bg-slate-950 text-left text-[11px] font-mono text-rose-300 mb-4 max-h-32 overflow-y-auto">
