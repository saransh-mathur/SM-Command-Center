...
export const CourseLabView: React.FC = () => {
 ...
 <div className="glass-panel rounded-2xl p-5 border-cyan-500/30 shadow-glass flex flex-col md:flex-row items-start md:items-center justify-between gap-4 relative overflow-hidden bg-slate-900/60">
 ...
 {/* Quick Rules Pill */}
 <div className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-slate-950/80 text-xs font-mono text-slate-300">
 ...
 : 'bg-slate-950/70 hover:border-slate-700'
 }`}
 >
 <div>
 <div className="flex items-center justify-between gap-2 mb-2">
 <span className="text-[10px] font-mono uppercase px-2 py-0.5 rounded bg-slate-900 text-cyan-300 font-semibold">
 ...
 <div className="flex items-center gap-2">
    ...
    <button 
      ...
      className="p-1 rounded bg-slate-800/50 hover:bg-rose-500/20 text-slate-500 hover:text-rose-400 transition-colors"
    >
 ...
 <div className="text-[11px] font-mono text-slate-400 line-clamp-1 bg-slate-950 p-1.5 rounded ">
 ...
 {!isAddingCourse ? (
   <motion.div
     ...
     className="p-4 rounded-2xl transition-all cursor-pointer flex flex-col items-center justify-center gap-3 bg-slate-950/70 hover:bg-slate-900 border-2 border-dashed border-slate-800 hover:border-cyan-500/50 text-slate-500 hover:text-cyan-400 min-h-[160px]"
   >
   ...
   <div className="p-4 rounded-2xl bg-slate-900 border border-cyan-500/50 flex flex-col gap-3 min-h-[160px]">
     <input
       type="text"
       placeholder="Course Title..."
       value={newCourseTitle}
       onChange={(e) => setNewCourseTitle(e.target.value)}
       className="w-full bg-slate-950 text-xs font-mono text-white px-3 py-2 rounded focus:outline-none focus:border-cyan-500"
     />
     <div className="flex items-center gap-2">
       <label className="text-[10px] font-mono text-slate-400">Total Sections:</label>
       <input
         type="number"
         value={newCourseSections}
         onChange={(e) => setNewCourseSections(parseInt(e.target.value) || 1)}
         className="w-16 bg-slate-950 text-xs font-mono text-white px-2 py-1 rounded focus:outline-none"
       />
     </div>
     <div className="flex gap-2 mt-auto">
       <button
         onClick={() => setIsAddingCourse(false)}
         className="flex-1 py-1.5 rounded bg-slate-800 text-slate-300 text-[10px] font-mono hover:bg-slate-700"
       >
         Cancel
       </button>
       <button
         ...
         className="flex-1 py-1.5 rounded bg-cyan-600 text-white font-bold text-[10px] font-mono hover:bg-cyan-500 shadow-glow-cyan"
       >
         Save
       </button>
     </div>
 ...
 <div className="lg:col-span-7 glass-panel rounded-2xl p-5 shadow-glass flex flex-col gap-4 bg-slate-900/60">
 ...
 <span className="text-2xl font-black font-mono text-cyan-400 tracking-widest bg-slate-950 px-3 py-1 rounded-xl ">
 ...
 <div className="p-3 rounded-xl bg-slate-950 text-xs font-mono flex items-center justify-between gap-2">
 <div>
 ...
 className="w-full p-3 rounded-xl bg-slate-950 font-mono text-xs text-cyan-300 focus:border-cyan-500 focus:outline-none leading-relaxed"
 />
 </div>
 ...
 className="w-full px-3 py-2 rounded-xl bg-slate-950 text-xs font-mono text-slate-200 focus:border-cyan-500 focus:outline-none"
 />
 </div>
 ...
 <div className="lg:col-span-5 glass-panel rounded-2xl p-5 shadow-glass flex flex-col gap-4 bg-slate-900/60">
 <div className="flex items-center justify-between pb-3 border-b ">
 <div className="flex items-center gap-2.5">
 ...
 className="flex-1 px-3 py-1.5 rounded-xl bg-slate-950 text-xs font-mono text-white focus:border-violet-500 focus:outline-none"
 />
 <button
 ...
 <div className="p-4 rounded-xl bg-slate-950 flex flex-col gap-3.5">
 <div>
 ...
 <pre className="p-2 rounded bg-slate-950 text-[11px] font-mono text-emerald-300 overflow-x-auto">
 ...
 <li key={i} className="text-xs text-slate-300 flex items-start gap-2 bg-slate-900/60 p-2 rounded ">
 ...
 <span>{q}</span>
    ...
    <div className="p-8 rounded-2xl bg-slate-950/70 border-2 border-dashed border-slate-800 flex flex-col items-center justify-center min-h-[300px] text-center">
      <div className="p-4 rounded-full bg-slate-900 mb-4">
        <Sparkles className="w-8 h-8 text-cyan-500/50" />
      </div>
      <h3 className="text-lg font-bold text-slate-300 mb-2">No Active Courses</h3>
