  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/85 backdrop-blur-md">
      <motion.div
        ...
        className="w-full max-w-md glass-panel rounded-2xl border border-amber-500/40 shadow-2xl p-6 relative"
      >
        {/* Header */}
        ...
        {/* Warning & Targets */}
        <div className="p-3.5 rounded-xl bg-amber-500/10 border border-amber-500/30 text-amber-200 text-xs mb-4">
        ...
        {/* Actions */}
        {cleanedResult ? (
          <div className="p-4 rounded-xl bg-emerald-500/15 border border-emerald-500/40 text-emerald-300 text-center font-mono text-xs">
          ...
          <div className="flex items-center justify-end gap-2 pt-2">
            <button
              onClick={closeModal}
              disabled={isCleaning}
              className="px-3.5 py-2 rounded-xl bg-slate-900 border border-slate-800 text-xs font-mono text-slate-400 hover:text-slate-200"
            >
              Cancel
            </button>
            <motion.button
