...
export const DiagnosticReportModal: React.FC = () => {
 ...
 className="w-full max-w-5xl h-[92vh] glass-panel rounded-2xl border-cyan-500/40 shadow-2xl p-4 sm:p-6 flex flex-col justify-between relative overflow-hidden"
 >
 {/* Top Header Bar */}
 ...
 <div className="flex items-center gap-2">
 {/* View Mode Toggle */}
 <div className="flex items-center p-1 bg-slate-900 rounded-xl font-mono text-xs">
 <button
 ...
 {/* Content Area */}
 <div className="flex-1 overflow-hidden relative rounded-xl bg-slate-950/60 flex flex-col">
 {viewMode === 'iframe' ? (
 ...
 <div className="p-4 rounded-xl bg-slate-900/80 font-mono text-xs">
 ...
 target="_blank"
 rel="noreferrer"
 className="px-3.5 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-300 hover:text-white text-xs font-mono flex items-center gap-1.5 transition-all"
 >
