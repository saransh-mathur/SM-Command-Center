  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/85 backdrop-blur-md">
      <motion.div
        ...
        className="w-full max-w-md glass-panel rounded-2xl border border-cyan-500/40 shadow-2xl p-6 relative text-center"
      >
        {/* Top Header */}
        ...
        <div className="relative flex items-center justify-center h-48 mb-6">
          ...
          <motion.div
            ...
            className="w-32 h-32 rounded-full bg-gradient-to-br from-cyan-500/30 to-violet-500/30 border border-cyan-400/50 blur-md absolute"
          />
