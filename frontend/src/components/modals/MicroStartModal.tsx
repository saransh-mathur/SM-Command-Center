      ...
      >
        ...
        <div className="mb-4">
          ...
          <div className="space-y-1.5 mb-2.5">
            {STARTER_TASKS.map((task) => (
              <button
                ...
                className={`w-full text-left text-xs p-2 rounded-lg border transition-all font-sans ${
          ...
          <input
            ...
            className="w-full px-3 py-2 rounded-lg bg-slate-900 border border-slate-800 text-xs text-slate-100 placeholder-slate-500 focus:outline-none focus:border-emerald-500/50 font-mono"
          />
        </div>

        {/* Countdown Center */}
        <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 text-center mb-5">
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <button
              ...
              className="px-3 py-2 rounded-xl bg-cyan-500/20 hover:bg-cyan-500/30 border border-cyan-500/40 text-cyan-300 text-xs font-mono font-bold flex items-center gap-1.5"
            >
