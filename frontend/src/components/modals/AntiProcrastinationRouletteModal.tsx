...
export const AntiProcrastinationRouletteModal: React.FC = () => {
 ...
 className="w-full max-w-xl glass-panel rounded-2xl border-emerald-500/50 shadow-2xl p-6 relative overflow-hidden"
 >
 {/* Top Glow Ambient */}
 ...
 <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-slate-800 text-emerald-300 font-semibold">
 &lt;3 MINUTE PROTOCOL
 </span>
 </div>
 ...
 <button
 onClick={closeModal}
 className="p-1.5 rounded-lg bg-slate-900 hover:border-slate-700 text-slate-400 hover:text-white transition-all cursor-pointer"
 >
 <X className="w-4 h-4" />
 </button>
 </div>
 ...
 className={`p-5 rounded-xl bg-slate-950/70 ${trackBadge.color.split(' ')[2]} relative overflow-hidden mb-5`}
 >
 ...
 <span className="text-xs font-mono text-slate-400 flex items-center gap-1 bg-slate-900 px-2 py-1 rounded-md ">
 ...
 <div className="p-2.5 rounded-lg bg-slate-900/90 text-[11px] text-slate-300 font-mono flex items-start gap-2">
 ...
 <div className="p-4 rounded-xl bg-slate-950/80 mb-5">
 ...
 onClick={handleSpin}
 disabled={isSpinning}
 className="px-3.5 py-2 rounded-xl bg-slate-900 hover:border-slate-600 text-slate-200 text-xs font-mono font-bold flex items-center gap-2 transition-all cursor-pointer hover:bg-slate-800"
 >
 ...
 <button
 onClick={closeModal}
 className="px-3.5 py-2 rounded-xl bg-slate-900 text-xs text-slate-400 hover:text-slate-200 font-mono transition-all cursor-pointer"
 >
 Close
 </button>
 <button
