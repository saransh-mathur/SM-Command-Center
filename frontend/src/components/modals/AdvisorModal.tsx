...
export const AdvisorModal: React.FC = () => {
 ...
 className="w-full max-w-lg glass-panel rounded-2xl shadow-2xl p-6 relative"
 >
 {/* Header */}
 ...
 <div className="p-3.5 rounded-xl bg-slate-950/80 mb-4 text-xs font-mono">
 ...
 className="w-full text-left text-xs p-2 rounded-lg bg-slate-900/60 hover:bg-slate-900 text-slate-300 hover:text-white font-sans transition-all flex items-center justify-between"
 >
 <span>• {p}</span>
 ...
 className="p-3.5 rounded-xl bg-slate-900 border-cyan-500/30 text-xs font-mono mb-4 text-slate-200 whitespace-pre-line"
 >
 {response}
 </motion.div>
 )}
 ...
 className="flex-1 px-3.5 py-2 rounded-xl bg-slate-900 text-xs text-slate-100 placeholder-slate-500 focus:outline-none focus:border-cyan-500 font-mono"
 />
 <button
 onClick={handleAsk}
