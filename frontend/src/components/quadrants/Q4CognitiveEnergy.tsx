...
export const Q4CognitiveEnergy: React.FC = () => {
 ...
 {/* ========================================================= */}
 <div className="mb-4 p-4 rounded-xl bg-slate-950/60 flex flex-col sm:flex-row items-center justify-between gap-4">
 ...
 {/* ========================================================= */}
 <div className="mb-4 p-3 rounded-xl bg-slate-950/60 flex items-center justify-between gap-3 font-mono text-xs">
 ...
 <div className="flex items-center gap-2">
 <span className={`px-2 py-1 rounded bg-slate-900 font-bold ${
 isBufferRunning ? 'border-cyan-500/40 text-cyan-300' : ' text-slate-400'
 }`}>
 ...
 <div className="p-3 rounded-xl bg-slate-950/60 flex items-center justify-between gap-2">
 <div className="flex items-center gap-2">
 <div className={`p-2 rounded-lg ${
 isNsdrPlaying ? 'bg-violet-500/20 border-violet-500/40 text-violet-300' : 'bg-slate-900 text-slate-400'
 }`}>
