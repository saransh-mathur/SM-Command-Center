  ...
  return (
    <div className="glass-panel rounded-2xl p-5 border border-slate-800/80 shadow-glass flex flex-col justify-between h-full relative overflow-hidden group hover:border-slate-700 transition-all">
      ...
      <div>
        ...
        {/* ========================================================= */}
        <div className="mb-4 p-4 rounded-xl bg-slate-950/60 border border-slate-800/80 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        {/* ========================================================= */}
        <div className="mb-4 p-3 rounded-xl bg-slate-950/60 border border-slate-800/80 flex items-center justify-between gap-3 font-mono text-xs">
          <div className="flex items-center gap-2.5">
            <div className="p-2 rounded-lg bg-cyan-500/10 border border-cyan-500/30 text-cyan-400">
              <ArrowRightLeft className="w-4 h-4" />
            </div>
            <div>
              <span className="text-slate-200 font-bold block">10-Min Context-Switch Buffer</span>
          ...
          <div className="flex items-center gap-2">
            <span className={`px-2 py-1 rounded bg-slate-900 border font-bold ${
              isBufferRunning ? 'border-cyan-500/40 text-cyan-300' : 'border-slate-800 text-slate-400'
            }`}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
          ...
          <motion.button
            ...
            className="p-3 rounded-xl bg-gradient-to-br from-cyan-500/20 via-blue-500/10 to-violet-500/20 border border-cyan-500/30 text-left flex items-center justify-between group cursor-pointer"
          >
            <div className="flex items-center gap-2.5">
          ...
          <div className="p-3 rounded-xl bg-slate-950/60 border border-slate-800/80 flex items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              <div className={`p-2 rounded-lg border ${
                isNsdrPlaying ? 'bg-violet-500/20 border-violet-500/40 text-violet-300' : 'bg-slate-900 border-slate-800 text-slate-400'
              }`}>
