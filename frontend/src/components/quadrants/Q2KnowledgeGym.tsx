...
export const Q2KnowledgeGym: React.FC = () => {
  ...
  return (
    <div className="glass-panel rounded-2xl p-5 border border-slate-800/80 shadow-glass flex flex-col justify-between h-full relative overflow-hidden group hover:border-slate-700 transition-all">
        ...
        <div className="mb-4 p-3.5 rounded-xl bg-slate-950/60 border border-slate-800/80">
          ...
          <div className="flex items-center justify-between text-xs font-mono text-slate-400 pt-2 border-t border-slate-900">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="text-[11px] px-2 py-1 rounded bg-slate-900 hover:bg-slate-800 border border-slate-800 text-slate-300 flex items-center gap-1"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-[11px] px-2 py-1 rounded bg-cyan-500/10 hover:bg-cyan-500/20 border border-cyan-500/30 text-cyan-300 flex items-center gap-1"
              >
          ...
          <AnimatePresence>
            {showDsaCode && (
              ...
              >
                <pre className="p-2.5 rounded-lg bg-slate-900 text-cyan-300 font-mono text-[11px] overflow-x-auto border border-slate-800 leading-tight">
        ...
        <div className="mb-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="text-[11px] font-mono px-2 py-0.5 rounded bg-slate-900 hover:bg-slate-800 border border-slate-800 text-amber-300 flex items-center gap-1"
              >
              ...
              <button
                ...
                className="text-[11px] font-mono px-2 py-0.5 rounded bg-slate-900 hover:bg-slate-800 border border-slate-800 text-slate-300 flex items-center gap-1"
              >
                <span>Next Card</span>
                <ChevronRight className="w-3 h-3" />
              </button>
          ...
          >
            <motion.div
              ...
              className="w-full h-full relative transform-style-3d p-3.5 rounded-xl bg-slate-950/80 border border-amber-500/30 shadow-sm flex flex-col justify-between"
            >
              {!isFlipped ? (
                <div>
                ...
                <div className="rotate-y-180">
                  ...
                  <div className="p-1.5 rounded bg-slate-900 text-amber-300 font-mono text-[11px] border border-amber-500/20">
        ...
        <div className="p-3 rounded-xl bg-slate-950/40 border border-slate-800/80">
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 px-3 py-1.5 rounded-lg bg-slate-900 border border-slate-800 text-xs text-slate-100 placeholder-slate-500 focus:outline-none focus:border-cyan-500/50 font-mono"
            />
            <button
          ...
          {generatedCard && (
            <motion.div
              ...
              className="mt-2.5 p-2.5 rounded-lg bg-slate-900 border border-cyan-500/30 text-xs font-mono"
            >
