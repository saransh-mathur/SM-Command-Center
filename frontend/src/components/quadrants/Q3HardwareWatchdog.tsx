  ...
  return (
    <div className="glass-panel rounded-2xl p-5 border border-slate-800/80 shadow-glass flex flex-col justify-between h-full relative overflow-hidden group hover:border-slate-700 transition-all">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 mb-4">
          ...
          <div className="p-3 rounded-xl bg-slate-950/60 border border-slate-800/80 font-mono">
            ...
            <div className="text-base sm:text-lg font-black text-slate-100 truncate">
              {telemetry.fanRpm} <span className="text-xs font-normal text-slate-400">RPM</span>
            </div>
            <div className="w-full h-1.5 rounded-full bg-slate-800 mt-2 overflow-hidden">
              <div
          ...
          <div className="p-3 rounded-xl bg-slate-950/60 border border-slate-800/80 font-mono">
            <div className="flex items-center justify-between text-slate-400 text-xs mb-1">
              ...
              <span className="text-[10px] text-slate-400">{telemetry.ramUsed}G</span>
            </div>
            <div className="text-base sm:text-lg font-black text-slate-100">
        ...
        <div className="mb-4 p-3 rounded-xl bg-slate-950/50 border border-slate-800/80 flex items-center justify-between gap-3">
          <div className="flex items-center gap-2">
          ...
          <div className="space-y-2">
            {containers.map((container) => {
              ...
              return (
                <div
                  key={container.id}
                  className="p-2.5 rounded-xl bg-slate-950/60 border border-slate-800/80 flex items-center justify-between gap-3 text-xs font-mono"
                >
                  <div className="flex items-center gap-2.5">
                    ...
                    />
                    <div>
                      <span className="text-slate-200 font-bold block">{container.name}</span>
                  ...
                  <div className="flex items-center gap-3">
                    <span className="text-[11px] text-slate-400">{container.memoryUsage}</span>
                    <button
        ...
        <motion.button
          ...
          className="w-full p-3 rounded-xl bg-gradient-to-r from-amber-600/30 via-rose-600/20 to-amber-600/30 hover:from-amber-600/40 hover:to-rose-600/30 border border-amber-500/40 text-amber-200 font-mono font-bold flex items-center justify-between shadow-sm transition-all"
        >
          <div className="flex items-center gap-2.5">
          ...
          <div className="flex items-center gap-1 text-xs px-2.5 py-1 rounded bg-amber-500/20 border border-amber-500/30 text-amber-300">
