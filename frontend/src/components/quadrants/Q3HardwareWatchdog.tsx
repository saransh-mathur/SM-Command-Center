...
export const Q3HardwareWatchdog: React.FC = () => {
 ...
 <div className="mb-4 p-3 rounded-xl bg-slate-950/50 flex items-center justify-between gap-3">
 <div className="flex items-center gap-2">
 ...
 <div
 key={container.id}
 className="p-2.5 rounded-xl bg-slate-950/60 flex items-center justify-between gap-3 text-xs font-mono"
 >
