...
export const FloatingDock: React.FC = () => {
 ...
 return (
 <div className="fixed bottom-5 left-1/2 transform -translate-x-1/2 z-40 px-3 py-2 rounded-2xl glass-panel shadow-dock flex items-center gap-2 max-w-full overflow-x-auto">
 <div className="hidden sm:flex items-center gap-1.5 pl-2 pr-3 border-r text-[10px] font-mono text-slate-400 uppercase tracking-wider">
 ...
 className={`px-3 sm:px-4 py-2 rounded-xl flex items-center gap-2.5 transition-all cursor-pointer ${advisor.color}`}
 >
