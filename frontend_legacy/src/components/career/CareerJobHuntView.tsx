...
const STAGES: { key: JobStage; label: string; color: string; border: string }[] = [
 { key: 'targeted', label: 'Targeted', color: 'text-slate-700 bg-slate-200/80', border: '' },
...
export const CareerJobHuntView: React.FC = () => {
 ...
 <span className="text-xs font-mono font-semibold px-2.5 py-0.5 rounded-full bg-emerald-500/10 border-emerald-500/30 text-emerald-400">
 ...
 <div className="flex items-center p-1 rounded-xl bg-slate-50 border border-slate-100 font-mono text-xs shadow-inner">
 <button
 ...
 className={`px-3.5 py-1.5 rounded-lg flex items-center gap-1.5 transition-all cursor-pointer ${
 activeTab === 'templates'
 ? 'bg-cyan-500/20 text-cyan-300 border-cyan-500/40 font-bold shadow-glow-cyan'
 : 'text-slate-500 hover:text-slate-800'
 }`}
 >
 ...
 className={`px-3.5 py-1.5 rounded-lg flex items-center gap-1.5 transition-all cursor-pointer ${
 activeTab === 'projects'
 ? 'bg-violet-500/20 text-violet-300 border-violet-500/40 font-bold shadow-glow-violet'
 : 'text-slate-500 hover:text-slate-800'
 }`}
 >
 ...
 className="bg-slate-900 text-white hover:bg-slate-800 font-medium px-4 py-2 rounded-xl text-sm transition-all shadow-sm cursor-pointer flex items-center gap-2"
 >
 ...
 <div
 key={stage.key}
 className="bg-white rounded-2xl border border-slate-200/80 p-6 shadow-sm hover:shadow-md transition-all duration-200 flex flex-col gap-3 min-h-[520px]"
 >
 {/* Stage Header */}
 <div className="flex items-center justify-between pb-2 border-b ">
 <span className={`text-xs font-mono font-bold px-2.5 py-1 rounded-lg ${stage.border} ${stage.color}`}>
 {stage.label}
 </span>
 <span className="text-xs font-mono text-slate-500 font-bold bg-slate-50 px-2 py-0.5 rounded-md ">
 {stageApps.length}
 </span>
 </div>
 ...
 {stageApps.length === 0 ? (
 <div className="p-6 text-center rounded-xl border-dashed text-slate-500 text-xs font-mono">
 ...
 className="p-3.5 rounded-xl bg-slate-50 border border-slate-100 hover:border-slate-700 transition-all shadow-md group relative flex flex-col gap-2"
 >
 <div className="flex items-start justify-between gap-2">
 <div>
 <h4 className="text-sm font-extrabold text-slate-900 group-hover:text-emerald-400 transition-colors">
 {app.company}
 </h4>
 ...
 {app.salaryRange && (
 <span className="inline-flex items-center gap-0.5 text-emerald-400 bg-emerald-500/10 px-1.5 py-0.5 rounded border-emerald-500/20">
 <DollarSign className="w-3 h-3" />
 {app.salaryRange}
 </span>
 )}
 <span className="inline-flex items-center gap-0.5 text-slate-500 bg-slate-100 px-1.5 py-0.5 rounded ">
 ...
 <span
 key={t}
 className="text-[10px] font-mono px-1.5 py-0.5 rounded bg-slate-100 text-cyan-300"
 >
 {t}
 </span>
 ))}
 ...
 {app.notes && (
 <p className="text-[11px] text-slate-500 bg-slate-50 border border-slate-100 p-2 rounded-lg line-clamp-2">
 {app.notes}
 </p>
 )}
 ...
 className="text-[10px] font-mono bg-slate-100 text-slate-700 rounded px-1.5 py-1 focus:outline-none focus:border-emerald-500 cursor-pointer"
 >
 ...
 : 'bg-slate-50 border border-slate-100 text-slate-500 hover:text-slate-900'
 }`}
 >
 {cat.label}
 </button>
 ...
 <div
 key={tpl.id}
 className="bg-white rounded-2xl border border-slate-200/80 p-6 shadow-sm hover:shadow-md transition-all duration-200 flex flex-col justify-between gap-4 group hover:border-slate-700"
 >
 <div>
 ...
 <span
 key={t}
 className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-slate-200 text-slate-700"
 >
 {t}
 </span>
 ))}
 ...
 <div className="mb-2">
 <span className="text-xs font-mono text-slate-500 block mb-0.5">Subject:</span>
 <p className="text-xs font-mono text-cyan-300 font-semibold bg-slate-50 p-2 rounded-lg ">
 {tpl.subject}
 </p>
 </div>

 <div>
 <span className="text-xs font-mono text-slate-500 block mb-0.5">Body:</span>
 <pre className="text-xs font-mono text-slate-800 bg-slate-50/90 p-3 rounded-xl whitespace-pre-wrap leading-relaxed max-h-48 overflow-y-auto">
 {tpl.body}
 </pre>
 </div>
 </div>
 ...
 <div
 key={proj.id}
 className="bg-white rounded-2xl border border-slate-200/80 p-6 shadow-sm hover:shadow-md transition-all duration-200 flex flex-col justify-between gap-4"
 >
 <div>
 ...
 target="_blank"
 rel="noreferrer"
 className="p-2 rounded-xl bg-slate-100 text-slate-700 hover:text-slate-900 hover:border-slate-700 transition-all"
 >
 ...
 <span
 key={tech}
 className="text-[11px] font-mono px-2 py-0.5 rounded-md bg-slate-100 text-violet-300"
 >
 {tech}
 </span>
 ))}
 ...
 className="px-4 py-2 rounded-xl bg-slate-100 hover:border-slate-600 text-slate-800 text-xs font-mono font-bold flex items-center gap-2 transition-all cursor-pointer"
 >
 {copiedId === proj.id ? (
 <>
