...
export const Q1ControllableInputs: React.FC = () => {
 ...
 return (
 <div className="bg-white rounded-2xl border border-slate-200/80 p-6 shadow-sm hover:shadow-md transition-all duration-200 flex flex-col justify-between h-full relative overflow-hidden group hover:border-slate-700 transition-all">
 ...
 className="p-1.5 rounded-lg bg-slate-50 border border-slate-100 hover:border-slate-700 text-slate-500 hover:text-slate-800 transition-all cursor-pointer"
 >
 ...
 className="p-3 rounded-xl bg-slate-50 hover:border-slate-600 text-slate-800 font-bold text-xs flex items-center justify-between cursor-pointer"
 >
 <div className="flex items-center gap-2">
 ...
 <div className="p-3 rounded-xl bg-slate-50 border border-slate-100 mb-4 flex items-center justify-between gap-4">
 <div className="flex items-center gap-3">
 <div className="w-10 h-10 rounded-full bg-slate-100 border-emerald-500/40 flex items-center justify-center text-xs font-mono font-bold text-emerald-300">
 {dailyScore}%
 </div>
 <div>
 <span className="text-xs font-extrabold text-slate-900">Daily Execution Momentum</span>
 ...
 <div className="w-36 bg-slate-100 h-2 rounded-full overflow-hidden hidden sm:block">
 <div 
 ...
 <div className={`p-1.5 rounded-lg bg-slate-100 ${item.accentColor}`}>
 ...
 className="p-1 rounded bg-slate-100 text-slate-500 hover:text-slate-900 transition-colors cursor-pointer"
 >
 <Minus className="w-3 h-3" />
 </button>
 <span className="text-xs font-mono font-bold text-white px-2 py-0.5 rounded bg-slate-100 ">
 {item.current}/{item.target}
 </span>
 <button
 onClick={() => incrementTarget(item.key)}
 className="p-1 rounded bg-slate-100 text-emerald-400 hover:text-emerald-300 transition-colors cursor-pointer"
 >
