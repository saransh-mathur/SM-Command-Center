...
export const Q2KnowledgeGym: React.FC = () => {
 ...
 {/* ========================================================= */}
 <div className="mb-4 p-3.5 rounded-xl bg-slate-50 border border-slate-100 ">
 ...
 <div className="flex items-center justify-between text-xs font-mono text-slate-500 pt-2 border-t ">
 <div className="flex items-center gap-3">
 ...
 className="text-[11px] px-2 py-1 rounded bg-slate-100 hover:bg-slate-200 text-slate-700 flex items-center gap-1"
 >
 ...
 >
 <pre className="p-2.5 rounded-lg bg-slate-100 text-cyan-300 font-mono text-[11px] overflow-x-auto leading-tight">
 ...
 <p className="text-xs text-slate-800 font-medium mb-2.5">
 "{currentPrep.prompt}"
 </p>

 <div className="grid grid-cols-2 sm:grid-cols-4 gap-1.5 text-[10px] font-mono text-slate-500">
 ...
 className="text-[11px] font-mono px-2 py-0.5 rounded bg-slate-100 hover:bg-slate-200 text-amber-300 flex items-center gap-1"
 >
 ...
 className="text-[11px] font-mono px-2 py-0.5 rounded bg-slate-100 hover:bg-slate-200 text-slate-700 flex items-center gap-1"
 >
 <span>Next Card</span>
 <ChevronRight className="w-3 h-3" />
 </button>
 ...
 className="w-full h-full relative transform-style-3d p-3.5 rounded-xl bg-slate-50 border border-slate-100 border-amber-500/30 shadow-sm flex flex-col justify-between"
 >
 {!isFlipped ? (
 <div>
 ...
 <p className="text-xs text-slate-700 font-sans mb-1.5">
 {currentMba.answer}
 </p>
 <div className="p-1.5 rounded bg-slate-100 text-amber-300 font-mono text-[11px] border-amber-500/20">
 ...
 {/* ========================================================= */}
 <div className="p-3 rounded-xl bg-slate-50/40 ">
 ...
 className="flex-1 px-3 py-1.5 rounded-lg bg-slate-100 text-xs text-slate-100 placeholder-slate-500 focus:outline-none focus:border-cyan-500/50 font-mono"
 />
 <button
 ...
 className="mt-2.5 p-2.5 rounded-lg bg-slate-100 border-cyan-500/30 text-xs font-mono"
 >
 <span className="text-[10px] text-cyan-400 block font-bold">FEYNMAN 3-STAGE CARD: {generatedCard.topic}</span>
 <p className="text-slate-700 text-[11px] mt-1">{generatedCard.recallQ}</p>
