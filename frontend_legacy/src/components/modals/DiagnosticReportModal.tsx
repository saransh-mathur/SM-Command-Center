...
export const DiagnosticReportModal: React.FC = () => {
 ...
 className="bg-white rounded-3xl border border-slate-100 shadow-2xl max-w-5xl w-full p-6 space-y-5 h-[92vh] flex flex-col justify-between relative overflow-hidden"
 >
 {/* Top Header Bar */}
 <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 mb-3 border-b flex-shrink-0">
 ...
 <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-300 border-emerald-500/40">
 LIVE SYNC
 </span>
 </div>
 ...
 <div className="flex items-center gap-2">
 {/* View Mode Toggle */}
 <div className="flex items-center p-1 bg-slate-100 rounded-xl font-mono text-xs">
 <button
 ...
 {/* Content Area */}
 <div className="flex-1 overflow-hidden relative rounded-xl bg-slate-50 border border-slate-100 flex flex-col">
 {viewMode === 'iframe' ? (
 ...
 <span className="text-slate-800 font-bold">Zorin OS 17.2 LTS</span>
 ...
 <span className="text-slate-800 font-bold">Intel i5-9300H</span>
 ...
 <span className="text-slate-800 font-bold">GTX 1650 Mobile</span>
 ...
 <span className="text-slate-500">Core Package Temp:</span>
 <span className="text-emerald-400 font-bold">{telemetry.cpuTemp}°C (Optimal)</span>
 </div>
 <div className="flex justify-between mb-1.5">
 <span className="text-slate-500">GPU Core Temp:</span>
 <span className="text-amber-400 font-bold">{telemetry.gpuTemp}°C</span>
 </div>
 <div className="flex justify-between">
 <span className="text-slate-500">NBFC Fan RPM:</span>
 ...
 <div className="flex justify-between mb-1.5">
 <span className="text-slate-500">Swap Pressure:</span>
 <span className="text-slate-700 font-bold">{telemetry.swapUsed} GB ({telemetry.swapPercent}%)</span>
 </div>
 <div className="flex justify-between">
 ...
 {/* Bottom Actions Bar */}
 <div className="flex flex-wrap items-center justify-between gap-3 pt-3 mt-3 border-t flex-shrink-0">
 <div className="flex items-center gap-2">
 <motion.button
 ...
 className="px-4 py-2 rounded-xl bg-cyan-500/20 hover:bg-cyan-500/30 border-cyan-500/40 text-cyan-300 text-xs font-mono font-bold flex items-center gap-2 shadow-sm"
 >
 ...
 target="_blank"
 rel="noreferrer"
 className="px-3.5 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 hover:text-slate-900 text-xs font-mono flex items-center gap-1.5 transition-all"
 >
 ...
 <button
 onClick={closeModal}
 className="px-4 py-2 rounded-xl bg-slate-200 hover:bg-slate-700 text-slate-800 text-xs font-mono font-bold"
 >
 Close Dashboard
 </button>
 </div>
