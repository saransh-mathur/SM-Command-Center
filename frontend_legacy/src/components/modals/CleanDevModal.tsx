...
export const CleanDevModal: React.FC = () => {
 ...
 <ul className="space-y-1 list-disc list-inside text-[11px] text-slate-700 font-mono">
 ...
 onClick={closeModal}
 disabled={isCleaning}
 className="px-3.5 py-2 rounded-xl bg-slate-100 text-xs font-mono text-slate-500 hover:text-slate-800"
 >
 Cancel
 </button>
 <motion.button
