...
export const BreathworkModal: React.FC = () => {
 ...
 className="bg-white rounded-3xl border border-slate-100 shadow-2xl max-w-lg w-full p-6 space-y-5 relative text-center"
 >
 {/* Top Header */}
 ...
 {/* Phase Instructions */}
 <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-100 mb-5">
